" Based on Tomasz Święcicki <tomislater@gmail.com> config
" https://github.com/tomislater/dotfiles.git
set nocompatible
set encoding=utf-8
...
"" Abbreviations
" open help window verticaly
cabbrev vh vert help

nnoremap ; :

" creating new vertical window and jump to
nnoremap <leader>w <C-w>v<C-w>l

" swithing beetween currently open buffers ,,
...
" opening vimrc in vertical window
nnoremap <leader>ev <C-w><C-v><C-l>:e $MYVIMRC<cr>
nnoremap <leader>sv <C-w><C-v><C-l>:so $MYVIMRC<cr>
